...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "marcosrrj2@gmail.com", "36378912377", TipoCliente.PESSOAFISICA);
		...
		Pedido ped1 = new Pedido(null, dft.parse("30/09/2017 10:32"), cli1, e1);
		Pedido ped2 = new Pedido(null, dft.parse("10/10/2017 19:35"), cli1, e2);
